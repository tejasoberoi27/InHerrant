...
def is_tense_aux(o_tok, c_tok):
    ...
    set_tense_aux_lemma = {'सकूँग', 'ला', 'पा', 'ले', 'चाहि', 'जा', 'है', 'हो', 'लगा', 'पड', 'रह', 'चाहिए', 'कर', 'आ', 'गय', 'लग', 'था', 'खाना', 'पड़', 'सक', 'चुक', 'दे', 'खा'}
    set_tense_aux_stem = {'हुए', 'किए', 'ली', 'लाय', 'थे', 'कीज', 'चाह', 'दिय', 'खाए', 'किय',
    'जाओ', 'गई', 'पाय', 'ला', 'ले', 'लिय', 'पाएँग', 'जाएग', 'लगाएँग', 'जा', 'लगाऊँ', 'लिए', 'है',
    'हो', 'गईं', 'पाएँ', 'होंग', 'लाएँग', 'पाए', 'आईं', 'लो', 'रह', 'लाए', 'आए', 'कर', 'गय', 'हुईं',
    'पाओ', 'की', 'जाएँग', 'गए', 'थीं', 'हैं', 'होग', 'लग', 'आय', 'था', 'पड़', 'सक', 'चुक', 'हुआ',
    'दे', 'जाएँ', 'हुई', 'खाय', 'लीं', 'खा', 'आई', 'चाहिएँ', 'थी', 'दी'}
